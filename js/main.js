...
// const reserva = document.querySelector("#btnReservar");

// const reservar = document.querySelectorAll("option")
...
// reserva.addEventListener("click",confirmar);

// function confirmar(){

//     martes.setAttribute('option',"MARTES")
//     console.log(reservar.values+ " es el dia");
// }
